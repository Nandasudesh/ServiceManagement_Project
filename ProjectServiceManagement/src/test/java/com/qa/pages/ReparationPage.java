...
public class ReparationPage {
	...
	public void addClient(String client) {
		WaitUtility.waitForElement(driver, clientDropDown);
		page.clickOnElement(clientDropDown);
		WaitUtility.waitForElement(driver, clienttextBox);
	...
	public void uploadImageFile() throws AWTException {
		...
		page.fileUpload(driver, browse,
				"\"C:\\Users\\nanda\\Pictures\\Screenshots\\Screenshot 2023-03-04 191015.png\"");
		page.clickOnElement(uploadFinal);
	}

	public String actualUploadMessage() {
		WaitUtility.waitForElement(driver, uploadCompleteMessage);
		return page.getElementText(uploadCompleteMessage);
	...
	public boolean isUploadcompleted() {
		return uploadCompleteMessage.isDisplayed();
	}
